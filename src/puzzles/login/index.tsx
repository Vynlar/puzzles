...
export function LoginPuzzle() {
    ...
    function handleLogin() {
        ...
        if(title.toLowerCase() !== 'login') {
            ...
            setMessage({message: "Confirm Password field not recognized", tone: 'red'})
    ...
    function handleRegister() {
        ...
        if(title.toLowerCase() !== 'register') {
            ...
            setMessage({message: "Password must match Confirm Password", tone: 'red'})
            return false
        } else {
                ...
                <div className="bg-white border rounded">
                    <div className='p-6 space-y-8'>
                      {success ? (
                          ...
                          <>
                            <div className="space-y-8 px-1 overflow-hidden hide-scrollbars" style={{ height: 260 + barY }}>
                                <input
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            <div className="max-w-[500px] mx-auto pt-12 space-y-4">
                ...
                <a className="block text-blue-500 underline" href="/login/play">Begin &gt;</a>
            </div>
        </div>
    )
}
